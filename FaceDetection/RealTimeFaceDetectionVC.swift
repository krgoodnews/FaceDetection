...
class RealTimeFaceDetectionVC: UIViewController {
...
extension RealTimeFaceDetectionVC {
...
extension RealTimeFaceDetectionVC: AVCaptureVideoDataOutputSampleBufferDelegate {
